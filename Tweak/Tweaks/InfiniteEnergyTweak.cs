...
{
    [Tweak(Name = "InfiniteEnergy", Category = "Builds")]
    public class InfiniteEnergyTweak : Tweak
    {
        ...
        private static class InfiniteEnergyPatches_WearStation
        {
        ...
        private static class InfiniteEnergyPatches_BreakerManual
        {
        ...
        private static class InfiniteEnergyPatches_ChlorophyllConverter
        {
        ...
        private static class InfiniteEnergyPatches_ChlorophyllExtractor
        {
        ...
        private static class InfiniteEnergyPatches_OreExtractor
        {
        ...
        private static class InfiniteEnergyPatches_Slayer
        {
        ...
        private static class InfiniteEnergyPatches_SoilMiner
        {
        ...
        private static class InfiniteEnergyPatches_SoilMinerV2
        {
        ...
        private static class InfiniteEnergyPatches_Trapper
        {
        ...
        private static class InfiniteEnergyPatches_Vaporizer
        {
        ...
        private static class InfiniteEnergyPatches_WaterPump
        {
